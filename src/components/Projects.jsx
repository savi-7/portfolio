  ...
  const projects = [
    {
      ...
      description: 'A robust digital storefront leveraging MERN stack & ML. Built for massive inventory scale and intelligent product recommendations.',
    ...
    },
    {
      ...
      description: 'Embedded hardware engineering. Real-time ultrasonic obstacle detection paired with emergency SOS response systems for the visually impaired.',
    ...
    },
    {
      ...
      description: 'Role-Based Access Control architecture. A highly secure, pure PHP/MySQL relational database interface handling critical academic data.',
